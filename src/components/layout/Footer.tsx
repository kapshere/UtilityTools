...
import { Github, Twitter, Linkedin, Facebook, Instagram, ExternalLink, Heart, Mail, MapPin, Phone } from 'lucide-react';
  ...
  return (
    <footer className="bg-gradient-to-t from-muted/60 to-muted/10 backdrop-blur-sm border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
          <div className="space-y-4 md:col-span-5">
            <Link to="/" className="inline-block mb-2">
              <h3 className="text-2xl font-bold text-primary">ToolHub</h3>
            </Link>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/wishlist" className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center">
          ...
          <div className="md:col-span-2">
            <h4 className="text-md font-semibold mb-4 pb-1 border-b border-border">Resources</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/suggest-tool" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Suggest a Tool
                </Link>
              </li>
              <li>
          ...
          <div className="md:col-span-3">
            <h4 className="text-md font-semibold mb-4 pb-1 border-b border-border">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="w-4 h-4 text-muted-foreground mr-2 mt-0.5" />
                <span className="text-sm text-muted-foreground">
                  123 Tools Building, Tech Street<br />
                  San Francisco, CA 94107
                </span>
              </li>
              <li className="flex items-center">
                <Mail className="w-4 h-4 text-muted-foreground mr-2" />
                <a href="mailto:support@toolhub.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  support@toolhub.com
                </a>
              </li>
              <li className="flex items-center">
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col sm:flex-row justify-between items-center">
          <div className="mb-4 sm:mb-0">
            <p className="text-xs text-muted-foreground">
              &copy; {currentYear} ToolHub. All rights reserved.
            </p>
          </div>
      ...
      <div className={cn(
        ...
        Made with <Heart className="w-3 h-3 inline mx-1 text-red-500" /> by the ToolHub Team
      </div>
    </footer>
  );
};
