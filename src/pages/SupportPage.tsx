...
import { LifeBuoy, Mail, Phone, MessageCircle, FileQuestion, ChevronDown, Search, Send } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-16">
        ...
        <section className="container mx-auto px-4 mb-8">
          ...
          {/* FAQ Section */}
          <div className={cn("transition-all duration-300", activeTab === 'faq' ? 'block' : 'hidden')}>
          ...
          {/* Help Center Section */}
          <div className={cn("transition-all duration-300", activeTab === 'help' ? 'block' : 'hidden')}>
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-3">Help Center</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Browse our comprehensive guides and tutorials to learn how to make the most of our tools.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="font-semibold text-lg mb-2">
                      {["Getting Started Guide", "PDF Tools Tutorial", "Data Conversion Tips", "Image Processing Guide", "Text Manipulation Tools", "Advanced Features"][index]}
                    </h3>
                    <p className="text-muted-foreground text-sm mb-4">
                      Learn how to efficiently use our tools with step-by-step instructions and examples.
                    </p>
